...
VERSION = '0.6.7'
# This is a fork from https://github.com/jamescasbon/PyVCF/tree/master/vcf
# Due to various bugs in previous "versions" sharing same version number,
# and the fact that it's hard to spot when you're using the wrong version,
# we check it in here
